...
// const USER_SERV_DEST = 'C:/OpenServer/domains/'
// const USER_SERV_DEST = 'test',
          SITE_NAME = 'nevskiy-zalog',
          PC_USERNAME = 'Vadim';
...
const config = {
  ...
  dbname: 'andrejqb_nzalog',
  dbhost: '127.0.0.1:8889',
  dbuser: 'admin',
  dbpass: '12345',
  siteName: 'nevskiy-zalog',
  siteurl: 'localhost:8888/' + SITE_NAME,
  wpAdmin: 'admin',
  siteTtitle: 'Невский залог',
  siteDescr: '',
  ...
  dest: {
    ...
    vendor: path.join(paths.theme, 'vendor')
  },
  ...
  */
  ...
  phpIncludes: {
    ...
    // },
    buildStyles: {
      comment: 'Функция формирования стилей и скриптов для страницы при сохранении страницы',
      path: 'build-styles-scripts.php',
      onlyAdmin: true
    },
    generateImages: {
  ...
  get components() {
    let extname = '.' + (wordpress ? 'php' : 'html');
    return [].map(componentName => path.join(this.src.components, componentName, componentName + extname));
  },
